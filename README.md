...
fold panels, creates an approximately 2 cm constrained triangular mesh, and packs
all panels into one numbered `CLOTHES_###` object and collection at Y = -1 m.
Sewing labels and fold edges are retained as mesh attributes; sewing and Cloth
modifier setup are later workflow steps.
